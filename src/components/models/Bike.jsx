...
export function Bike({ ...props }) {
  ...
  return (
    <group {...props} dispose={null} position={[0, -3, 0]} scale={0.05}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group position={[-2.472, 0.662, 31.264]}>
          <group position={[2.472, -0.662, -31.264]}>
            <mesh
              ...
              material-color={props.customColors.complementar}
            />
            <mesh
              castShadow
              receiveShadow
        ...
        <group position={[-2.472, 0.127, 31.264]}>
          <mesh
            ...
            material-color={props.customColors.principal}
          />
        </group>
        <group position={[-2.472, 0.662, 31.264]}>
          <mesh
        ...
        <group position={[-2.472, 0.662, 31.264]}>
          <mesh
            ...
            material-color={props.customColors.contraste}
            position={[2.472, -0.662, -31.264]}
          />
        </group>
        <group position={[-2.472, 0.662, 31.264]}>
